...
export default function GamingStore() {
  ...
  return (
    <>
      ...
      <div dir={dir} className="min-h-screen" style={{ backgroundColor: '#0f172a' }}>
        {/* Header */}
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                {products.map(product => (
                  <div
                    key={product.id}
                    className="rounded-lg overflow-hidden border border-slate-700 hover:border-slate-500 transition shadow-lg hover:shadow-xl"
